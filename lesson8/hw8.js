...
for (const course of coursesAndDurationArray) {
    ...
    courseList.classList.add('course-block')
    courseList.innerText = `Title: ${course.title}, monthDuration: ${course.monthDuration}`
...
//     Завдання робити через цикли.
for (const course of coursesAndDurationArray) {
    let courseList2 = document.createElement('div')
    let title = document.createElement('h1')
    title.classList.add('heading')
    title.innerText =  `Title: ${course.title}`
    courseList2.appendChild(title)
    let paragraph = document.createElement('p')
    paragraph.classList.add('description')
    paragraph.innerText = `monthDuration: ${course.monthDuration}`
    courseList2.appendChild(paragraph)
    document.body.appendChild(courseList2)
...
for (const simpson of simpsons) {
    ...
    simpsonBlock.classList.add('member')
    ...
    simpsonBlock.append(name,surname,age,info,photo)
    document.body.appendChild(simpsonBlock)
    console.log(simpsonBlock)
...
for (const coursesArrayElement of coursesArray) {
    ...
    courses.classList.add('coursesDiv')
    let titleDiv = document.createElement('h2')
    titleDiv.innerText = `Title: ${coursesArrayElement.title}`
    let duration = document.createElement('div')
    duration.classList.add('durationDiv')
    ...
    courses.append(titleDiv,duration,text,modulesList)
